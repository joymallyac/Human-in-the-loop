...
from result.measure import calculate_accuracy,calculate_F1,calculate_average_odds_difference, calculate_equal_opportunity_difference, get_counts, measure_final_score
...
def run_ten_times_default():
    ...
    for i in range(3):
        ...
        print("accuracy:", 1 - calculate_accuracy(TP,FP,FN,TN))
        print("F1 Score:", 1 - calculate_F1(TP,FP,FN,TN))
...
def run_ten_times_FLASH():
    ...
    for i in range(3):
        ...
        print("accuracy :", 1 - measure_final_score(dataset_orig_test, clf, X_train, y_train, X_test, y_test, 'race', 'accuracy'))
